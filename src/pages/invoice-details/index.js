        ...
        <div className="invoice">
          ...
          <div className="footer">
            <div className="all-items">
              ...
              {invoice[0].items.map((i) => (
                <div className="item-details flexbox" key={i.id}>
                  ...
                  <b>{i.price.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</b>
                  </div>
                  <div className="total small black">
                  <b>{i.total.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}</b>
                  </div>
                </div>
              ))}
            </div>
            <div className="invoice-total flexbox">
              ...
              {invoice[0].granTotal.toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
              </div>
            </div>
          </div>
        </div>
